...
<link href="lib/searchMain2.css" rel="stylesheet">
     ...
     <form name=routeForm method=post action=getroute.php class="form-horizontal" id=routeForm>
      ...
      <div class="row">
       <div class="buttons-one-route">
        <span class="activebutton"><button class="roundtripBtn buttonup" id="roundtrip" name="roundtrip"><i class="fa fa-plane fa-lg"></i> Round-trip</button></span><button class="onewayBtn buttonup" id="oneway" name="oneway"><i class="fa fa-plane fa-lg"></i> One-way</button>
       </div>
      </div>
